...
public class Line {
	int xpos_a, ypos_a, xpos_b, ypos_b;
	...
	public Line(int a, int b, int c, int d) {
		...
		this.vertical = (this.xpos_a == this.xpos_b);
	}
	...
	public void draw_line(Graphics g, Color a, JPanel pane, int xpos, int ypos, String location, int line_width) {
		...
		if (location.equals("edit")) {
			...
			int[] xposst = {(int)this.a.x + pane.getWidth()/2 - xpos, (int)this.b.x + pane.getWidth()/2 - xpos};
			int[] yposst = {pane.getHeight() - ((int)this.a.y - ypos + pane.getHeight()/2), pane.getHeight() - ((int)this.b.y - ypos + pane.getHeight()/2)};
			xposs = xposst;
			yposs = yposst;
		}
