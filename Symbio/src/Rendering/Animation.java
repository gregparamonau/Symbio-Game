...
public class Animation {
	...
	public Animation(String file, int width, int height, int height_offset, boolean fliph, boolean flipv) {
		try {
			...
			for (int x = 0; x<length; x++) {
				this.sprites[x] = Utility.transformed_instance(temp.getSubimage(x * width, height_offset, width, height), 1, Color.black, 1);
			}
