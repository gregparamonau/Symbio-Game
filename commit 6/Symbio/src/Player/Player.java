...
public class Player extends Rectangle{
	...
	public static int fall_speed_slow = 15, fall_speed_normal = 25;
	...
	public Vector2 slash_bounds = new Vector2(30, 24);
	public Vector2 offset_slash = new Vector2(8, 12);
	
	public int slash_length = 7, slash_count = 0;
	...
	public int invincibility_frames_max = 30;
	...
	public void update() {
		...
		if (Game.up || this.slashing) this.max_fall_speed = (int)(fall_speed_slow * (this.slashing ? 0.5 : 1));
	...
	public void slash() {
		for (int x = 0; x<Game.current_room.enemies.length; x++) {
			if (Rectangle.intersect(new Rectangle(this.pos.x + this.slash_dir.x, this.pos.y + this.slash_dir.y, (this.slash_dir.x != 0 ? 1 : 0) * this.slash_bounds.x + (this.slash_dir.x == 0 ? 1: 0) * this.slash_bounds.y, (this.slash_dir.y != 0 ? 1.5 : 0) * this.slash_bounds.x + (this.slash_dir.y == 0 ? 1: 0) * this.slash_bounds.y), Game.current_room.enemies[x])) {
				...
				if (Game.current_room.enemies[x].damage(this.slash_strength)) {
					this.vel = Vector2.scale_to_length(this.slash_dir, -this.knockback * 0.5 * (this.slash_dir.x == 0 && this.slash_dir.y < 0 ? 2 : 1));
	...
	public Vector2 find_slash_dir() {
		...
		return new Vector2(this.offset_slash.x * this.last_dir, 0);
	}
