...
public class RoomEditor {	
	...
	public static String[] object_names = {"object", "spawner", "acid", "bouncer", "circle", "mover", "oneway", "slope"};
	...
	public static void draw_view(Graphics g) {
		...
		for (int x = 0; x<room.objects.length; x++) {
			room.objects[x].draw_object(g, LevelEditor.pane, LevelEditor.pos.x, LevelEditor.pos.y, "edit");
			
			Vector2 conv = Vector2.converted_pos(room.objects[x].pos, LevelEditor.pane, LevelEditor.pos.x, LevelEditor.pos.y, "edit");
	...
	public static void show_room_properties_panel() {
		...
		JOptionPane.showMessageDialog(LevelEditor.frame, options, "Select Option Menu", JOptionPane.PLAIN_MESSAGE);
	...
	public static void show_area_select() {
		...
		JOptionPane.showMessageDialog(LevelEditor.frame, areas, "Select Area", JOptionPane.PLAIN_MESSAGE);
