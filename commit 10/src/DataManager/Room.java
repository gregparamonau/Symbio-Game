...
public class Room extends Rectangle{
	...
	public void generate_terrain_sprites(String in) {
		...
		for (int x = 0; x<this.objects.length; x++) {
			...
			this.objects[x].draw_blank_object(g, new Rectangle(this.max_bounds.pos.x, this.max_bounds.pos.y, this.max_bounds.width + 2 * bump_depth, this.max_bounds.height + 2 * bump_depth));
		}
		...
		double chance_sub = 0.5, chance_sub_empty = 0.9, chance_cluster = 0.0e-2;
