...
public class Game {
	...
	public static void init_base() {
		...
		System.out.println(Camera.pixel_size);
		System.out.println(Camera.res_width + " | " + Camera.res_height);
		System.out.println(cam.back.getWidth() + " | " + cam.back.getHeight());
		System.out.println(cam.parallax[0].getWidth() + " | " + cam.parallax[0].getHeight());
		//System.exit(0);
	}
