...
public class PlayerRender {
	...
	public static void draw_player(Player in, Graphics g) {
		in.draw_with_sprite(g, Game.pane, Game.cam.pos.x, Game.cam.pos.y, sprite_to_play(in), "game");
		if (in.dash_num == 1) new Vector2(in.pos.x, in.pos.y + 10).draw_node(g, Game.pane, Game.cam.pos.x, Game.cam.pos.y, "game", Color.green);
		if (in.dash_num == 0) new Vector2(in.pos.x, in.pos.y + 10).draw_node(g, Game.pane, Game.cam.pos.x, Game.cam.pos.y, "game", Color.red);
	}
