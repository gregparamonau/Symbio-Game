...
public class GameObject extends Rectangle{
	...
	public GameObject(double a, double b, double c, double d, String sprite, int id) {
	...
	public static GameObject create_game_object(String[] in, int id) {
		if (in[0].equals("acid")) {
			return new Acid(Double.parseDouble(in[1]), Double.parseDouble(in[2]), Double.parseDouble(in[3]), Double.parseDouble(in[4]), in[5], id);
		}
		...
		GameObject temp = new GameObject(Double.parseDouble(in[1]), Double.parseDouble(in[2]), Double.parseDouble(in[3]), Double.parseDouble(in[4]), in[5], id);
	...
	public static GameObject default_object(Vector2 loc) {
		return new GameObject(loc.x, loc.y, LevelEditor.grid_size, LevelEditor.grid_size, sprite_name_default, 0);
	}
