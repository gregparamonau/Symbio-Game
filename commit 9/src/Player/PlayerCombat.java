...
public class PlayerCombat {
	...
	public Vector2 find_slash_dir() {
		if (this.player.face_dir.y != 0 && !(this.player.face_dir.y < 0 && this.player.col_down)) {
			return new Vector2(0, this.offset_slash.y * Utility.sign(this.player.face_dir.y));
		}
		return new Vector2(this.offset_slash.x * this.player.last_dir * (this.player.wall_slide ? -1 : 1), 0);
	}
