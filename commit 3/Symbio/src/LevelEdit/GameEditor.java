...
public class GameEditor {
	...
	public static void draw_view(Graphics g) {
		for (int x = 0; x<rooms_display.length; x++) {
			...
			g.drawString(x + "", (int)Rectangle.converted_pos(rooms_display[x].pos, LevelEditor.pane, LevelEditor.pos.x, LevelEditor.pos.y, "edit").x, (int)Rectangle.converted_pos(rooms_display[x].pos, LevelEditor.pane, LevelEditor.pos.x, LevelEditor.pos.y, "edit").y);
		}
